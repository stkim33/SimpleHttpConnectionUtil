package com.simplehttpconnectionutil.http.helpers;
...
final public class HttpUtility
{
	...
	{	
		...
		//Log.d("Unforget", "request : ========================================================");
		//Log.d("Unforget", "url : [" + url + "]");
		...
		if(getParameters != null)
		{
			...
			for(String key: getParameters.keySet())
			{
				...
				//Log.d("Unforget", "param : [" + key + "=" + getParameters.get(key) + "]");
			}
		}
		...
		{
			Log.d("", "SimpleHttpResponse.get : error");
			e.printStackTrace();
//			Logger.e(e.toString());
//			if(connection != null)
//				connection.disconnect();
		...
		if(headerValues != null) {
			for(String key: headerValues.keySet()) {
				...
				//Log.d("Unforget", "header : [" + key + "=" + headerValues.get(key) + "]");
			}
		}
